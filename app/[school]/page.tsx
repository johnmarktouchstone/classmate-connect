...
import { getSchoolByPublicSlug } from "@/lib/schools";

export default async function PublicSchoolSubmitPage({
  params,
}: {
  params: Promise<{ school: string }>;
}) {
  const { school: publicSchoolSlug } = await params;
  const school = getSchoolByPublicSlug(publicSchoolSlug.toLowerCase());
